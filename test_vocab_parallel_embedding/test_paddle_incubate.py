...
class TestPaddle(base_class.BaseClass):
    ...
    def _cal_eager_res(self, x, table, dout):
        ...
        embedding = fleet.meta_parallel.VocabParallelEmbedding(dim_1, dim_3, weight_attr=paddle.fluid.initializer.NumpyArrayInitializer(self._np_paddle_table), mp_group=self._group)
        out = embedding(x_t)
