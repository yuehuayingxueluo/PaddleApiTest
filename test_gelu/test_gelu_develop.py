...
class TestGeluDevelopCase1_FP32(unittest.TestCase):
    def setUp(self):
        self.init_params()
        self.init_threshold()
...
class TestGeluDevelopCase1_BFP16(TestGeluDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case1.npz"
        self.dtype = "bfloat16"
...
class TestGeluDevelopCase2_FP32(TestGeluDevelopCase1_FP32):
    def init_params(self):
...
class TestGeluDevelopCase2_FP16(TestGeluDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case2.npz"
        self.dtype = "float16"
...
class TestGeluDevelopCase2_BFP16(TestGeluDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case2.npz"
        self.dtype = "bfloat16"
