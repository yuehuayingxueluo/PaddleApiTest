...
class TestGeluIncubateCase1_FP32(unittest.TestCase):
    def setUp(self):
        self.init_params()
        self.init_threshold()
    ...
    def cal_torch_res(self, x, dout):
        ...
        out = torch.nn.functional.gelu(x_t)
    ...
    def test_eager_accuracy(self):
        ...
        np.testing.assert_equal(
            ...
            out_eager_develop,
            err_msg=(
                'Incubate: compare gelu incubate eager forward res with develop eager forward res failed in %s dtype'
            )
            % self.dtype,
        )
        for idx in range(len(out_grads_eager_np)):
            ...
            err_msg=(
                'Incubate: compare gelu incubate eager grad res with develop eager grad res failed in %s dtype'
            )
                % self.dtype,
            )
    ...
    def test_static_accuracy(self):
        ...
        np.testing.assert_equal(
            ...
            out_static_develop,
            err_msg=(
                'Incubate: compare gelu incubate static forward res with develop static forward res failed in %s dtype'
            )
            % self.dtype,
        )
        for idx in range(len(out_grads_static)):
            ...
            err_msg=(
                'Incubate: compare gelu incubate static grad res with develop static grad res failed in %s dtype'
            )
                % self.dtype,
            )
...
class TestGeluIncubateCase1_FP16(TestGeluIncubateCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case1.npz"
        self.dtype = "float16"
...
class TestGeluIncubateCase1_BFP16(TestGeluIncubateCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case1.npz"
        self.dtype = "bfloat16"
...
class TestGeluIncubateCase2_FP32(TestGeluIncubateCase1_FP32):
    def init_params(self):
...
class TestGeluIncubateCase2_FP16(TestGeluIncubateCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case2.npz"
        self.dtype = "float16"
...
class TestGeluIncubateCase2_BFP16(TestGeluIncubateCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case2.npz"
        self.dtype = "bfloat16"
